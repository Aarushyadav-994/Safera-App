...
*Developed at Delhi Technological University (DTU)*
...
This application stems from a research investigation into urban safety navigation conducted at DTU. The core hypothesis was that incorporating real-time safety metrics—such as crime rates, lighting quality, and crowd density—could significantly improve route recommendations for at-risk commuters. Our study collected safety data from various Delhi locations and developed a weighted scoring algorithm that balances multiple risk factors.
...
This JSON file contains sample safety metrics for various locations in Delhi. Each entry includes:
...
•  *API Key*: Included in RouteService.js (replace with your own for production)
•  *Endpoints Used*:
...
•  *Delhi Police Crime Data*: Public safety statistics (anonymized)
